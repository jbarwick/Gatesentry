...
- Binary version is `GATESENTRY_VERSION` in `main.go` (current: `2.0.0-beta.12`). That string is the only release tag. Do not invent a different version for the image.
